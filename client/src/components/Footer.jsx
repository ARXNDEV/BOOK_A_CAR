    ...
    <div className="bg-black text-white lg:pt-[100px] pb-[100px] p-10 rounded-none mt-[100px] lg:mt-[200px]" >
      <div className="w-full">
        <div className="grid  w-full justify-between lg:px-10 sm:flex sm:justify-between md:flex md:grid-cols-1 gap-y-10 pb-10">
          <div>
            <div className="py-2 mb-5 font-bold text-[18px] lg:text-[24px]"><h1>BOOK A CAR</h1></div>
          ...
          <div className="grid grid-cols-2 gap-8 sm:mt-4 sm:grid-cols-3 sm:gap-6 ">
            <div>
              ...
              <FooterLinkGroup col>
                <FooterLink href="#">BOOK A CAR</FooterLink>
            ...
            <div>
              ...
              <FooterLinkGroup col>
                <FooterLink href="https://github.com/ARXNDEV">Github</FooterLink>
        ...
        <div className="w-full sm:flex sm:items-center sm:justify-between lg:px-10 ">
          <FooterCopyright href="#" by="BOOK A CAR" year={2026} />
          <div className="mt-4 flex space-x-6 sm:mt-0 sm:justify-center">
            <FooterIcon href="#" icon={BsLinkedin} />
            <FooterIcon href="https://github.com/ARXNDEV" icon={BsGithub} />
            <FooterIcon href="https://www.instagram.com/why.arxn/" icon={BsInstagram} />
